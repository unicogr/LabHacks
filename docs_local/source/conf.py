...
pth='/home/nicolas/Documents/GitHubProjects/researchLog_template/docs_local/source/figures/co# Configuration file for the Sphinx documentation builder.
#
# For the full list of built-in configuration values, see the documentation:
# https://www.sphinx-doc.org/en/master/usage/configuration.html
...
''
    ...
    # Create an animated GIF from the matching images
    # Ensure ImageMagick is installed for the `convert` command
    convert -delay 50 -loop 0 sub-00_iso_run*_T2_T1_alignment.png animated_alignment.gif
